...
Benchee.run(
  %{
    "create_runtime_entry_file/5" => fn {runtime_mfas, ir_plt, async_mfas, app_versions, opts} ->
  ...
  before_scenario: fn _input ->
    ...
    {runtime_mfas, ir_plt, async_mfas, app_versions, opts}
  end,
  before_each: fn {runtime_mfas, ir_plt, async_mfas, app_versions, opts} ->
  ...
  formatters: [
    ...
    {Benchee.Formatters.Markdown,
     description: "Hologram.Compiler.create_runtime_entry_file/5",
