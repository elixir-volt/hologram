...
import ApplicationEnv from "./erts/application_env.ts";
import BinaryPatternRegistry from "./erts/binary_pattern_registry.ts";
import CallStack from "./erts/call_stack.ts";
import NativeObjectRegistry from "./erts/native_object_registry.ts";
import NodeTable from "./erts/node_table.ts";
import PromiseRegistry from "./erts/promise_registry.ts";
import RegexEngine from "./erts/regex/regex_engine.ts";
import RegexPatternRegistry from "./erts/regex_pattern_registry.ts";
