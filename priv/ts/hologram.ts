...
import ComponentRegistry from "./component_registry.ts";
import Config from "./config.ts";
import Debouncer from "./debouncer.ts";
import Deserializer from "./deserializer.ts";
import ERTS from "./erts.ts";
import EventListenerRegistry from "./event_listener_registry.ts";
import EventListeners from "./event_listeners.ts";
import GlobalRegistry from "./global_registry.ts";
import HologramBoxedError from "./errors/boxed_error.ts";
import HologramInterpreterError from "./errors/interpreter_error.ts";
import HologramRuntimeError from "./errors/runtime_error.ts";
import InitActionQueue from "./init_action_queue.ts";
import Interpreter from "./interpreter.ts";
import JsInterop from "./js_interop.ts";
import MemoryStorage from "./memory_storage.ts";
import Operation from "./operation.ts";
import PerformanceTimer from "./performance_timer.ts";
import Renderer from "./renderer.ts";
import Serializer from "./serializer.ts";
import Sse from "./sse.ts";
import Throttler from "./throttler.ts";
import Type from "./type.ts";
import UncaughtErrorOverlay from "./uncaught_error_overlay.ts";
import Utils from "./utils.ts";
import Vdom from "./vdom.ts";

// Events
import ChangeEvent from "./events/change_event.ts";
import ClickEvent from "./events/click_event.ts";
import ClickOutsideEvent from "./events/click_outside_event.ts";
import FocusEvent from "./events/focus_event.ts";
import InputEvent from "./events/input_event.ts";
import KeyboardEvent from "./events/keyboard_event.ts";
import MouseEvent from "./events/mouse_event.ts";
import PointerEvent from "./events/pointer_event.ts";
import ReachEvent from "./events/reach_event.ts";
import ResizeEvent from "./events/resize_event.ts";
import ScrollEvent from "./events/scroll_event.ts";
import SelectEvent from "./events/select_event.ts";
import SubmitEvent from "./events/submit_event.ts";
import TransitionEvent from "./events/transition_event.ts";

import ManuallyPortedElixirApplication from "./elixir/application.ts";
import ManuallyPortedElixirCldrLocale from "./elixir/cldr/locale.ts";
import ManuallyPortedElixirCldrValidityU from "./elixir/cldr/validity/u.ts";
import ManuallyPortedElixirCode from "./elixir/code.ts";
import ManuallyPortedElixirException from "./elixir/exception.ts";
import ManuallyPortedElixirFunctionClauseError from "./elixir/function_clause_error.ts";
import ManuallyPortedElixirHologramJS from "./elixir/hologram/js.ts";
import ManuallyPortedElixirHologramRouterHelpers from "./elixir/hologram/router/helpers.ts";
import ManuallyPortedElixirIO from "./elixir/io.ts";
import ManuallyPortedElixirKernel from "./elixir/kernel.ts";
import ManuallyPortedElixirString from "./elixir/string.ts";
import ManuallyPortedElixirStringTokenizer from "./elixir/string/tokenizer.ts";
import ManuallyPortedElixirTask from "./elixir/task.ts";
import ManuallyPortedElixirURI from "./elixir/uri.ts";
...
export default class Hologram {
  ...
  static #loadMountData() {
    const mountData = $.#mountData ?? globalThis.Hologram.pageMountData(Hologram.#deps);
  ...
  static #showNewPage(payload) {
    ...
    $.#mountData = {
      componentRegistry: Interpreter.evaluateJavaScriptExpression(payload.componentRegistry),
      ...
      subReceiptAdds: Interpreter.evaluateJavaScriptExpression(payload.subReceiptAdds),
      subReceiptDrops: Interpreter.evaluateJavaScriptExpression(payload.subReceiptDrops),
    };
